          ...
          <div class="view-wrapper">
                <div class="admin-title">
                    ...
                    <div class="admin-search">
                      <input class="ad-spe_add btn-blue btn-sm" type="button" name="" value="新增">
                    </div>                  
                </div>
            <div id="view">
              <table id="actTable">
...
<!--                 <th>動作</th>
            ...
            <?php 
                try {
                  require_once("php/connect.php");
                  //共幾筆
                  $sql = "select count(*) totalRecords from spe";
                ...
                //$pageRecords
                  ...
                  $sql = "select * from spe limit $start, $pageRecords";
                  $spe = $pdo->query( $sql);
                  while($speRow = $spe->fetch()){
                      echo '<tr>
                            ...
                            <td>
                              <i class="fa fa-pencil-square-o ad-spe_change" aria-hidden="true"></i>
                  ...
                  for( $i=1; $i<=$pages; $i++){
                    echo "<a href='admin_spe.php?pageNo=$i'> $i</a> &nbsp;&nbsp;&nbsp;";
                  }
                  echo "</td></tr></table>";
...
<script>
$(function(){
  $('.adminMenu li:nth-child(3)').addClass('show');
  $('#knowTable').show().css({'width':'95%'});
})
